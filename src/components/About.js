  ...
  const aboutDetails = (
    <div className="mt-5 max-w-lg">
      ...
      <div className="mt-4 flex flex-row items-center gap-3">
        ...
        >
          About Me
          <svg className="h-4 w-4 flex-shrink-0 sm:h-5 sm:w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <a
          ...
          className={`flex h-9 w-9 items-center justify-center rounded-md border transition duration-300 hover:-translate-y-1 ${theme === "light" ? `theme-soft-light theme-accent-text ${t.hoverAccent}` : `theme-sahara-border theme-sahara-icon ${t.hoverAccent}`}`}
          aria-label="LinkedIn"
        >
  ...
  const techStackCard = (
    <Card theme={theme} className="w-full max-w-[420px] p-5 text-left lg:min-h-[100%]">
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm font-bold">Tech Stacks</p>
